...
Vagrant.configure("2") do |config|
  ...
  config.vm.network "forwarded_port", guest: 80, host: 2081, protocol: "tcp"
  config.vm.network "forwarded_port", guest: 3306, host: 33306, protocol: "tcp"
  ...
  config.vm.synced_folder File.expand_path('../my-site', Dir.pwd), "/var/www/my-site", mount_options: ["dmode=777,fmode=777"]
